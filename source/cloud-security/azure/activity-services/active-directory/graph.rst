...
.. warning:: The field ``tenantdomain`` is mandatory. It can be obtain from the **Overview** section in the Microsoft Entra ID.

Microsoft Graph use case
------------------------

Here is an example of monitoring the Microsoft Entra ID activity using the configuration described above.
